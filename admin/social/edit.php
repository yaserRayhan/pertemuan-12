                            ...
                            <div class="card-body">
                                <input type="hidden" name="id" value="<?=$id ?>">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="nama_sosmed" class="form-control" placeholder="Masukan Nama Sosmed" value="<?= $namaSosmed ?>" required>
                                    </div>
                        <div class="form-group">
                            <label>Link</label>
                            <input type="text" name="link" class="form-control" placeholder="Masukan Link Sosmed" value="<?= $link ?>" required>
                        </div>
                        <div class="form-group">
